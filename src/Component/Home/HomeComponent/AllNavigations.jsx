...
const AllNavigations = () => {
    return (
        <div>
            <h2 className='mx-4 text-5xl py-8'>Best Website builders in the US</h2>
<hr />
<div className='flex my-4'> <p className='flex items-center mx-4'><svg width="20" height="20" className='mx-2' viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path fillRule="evenodd" clipRule="evenodd" d="M14.6084 7.21285C14.8525 7.44408 14.8525 7.81899 14.6084 8.05022L9.60845 12.787C9.36437 13.0183 8.96864 13.0183 8.72456 12.787L6.22456 10.4186C5.98048 10.1874 5.98048 9.81251 6.22456 9.58127C6.46864 9.35004 6.86437 9.35004 7.10845 9.58127L9.16651 11.531L13.7246 7.21285C13.9686 6.98162 14.3644 6.98162 14.6084 7.21285Z" fill="#626E79"/>
 ...
 Last Updated - February 22, 2020</p>
<p className="flex items-center mx-4"> <svg width="20" height="20" viewBox="0 0 20 20" className='mx-2' fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div className="">
  <ul className="flex flex-col md:flex-row">
    <li className=" mx-9 m-4">Tools</li>
    <li className="mx-9 m-4">AWS Builder</li>
    <li className="mx-9 m-4">Start Build</li>
    <li className="mx-9 m-4">Build Supplies</li>
    <li className="mx-9 m-4">Tooling</li>
    <li className="mx-9 m-4">BlueHosting </li>
  </ul>
</div>

<div>
  <ul className='flex flex-col md:flex-row text-center items-center ms-9 '>
    <li className='flex items-center'>Home <FaChevronRight className="m-2"/></li> 

    <li className='m-4 flex items-center'>Hosting for all <FaChevronRight className="mx-2"/></li>

    <li className='m-4 flex items-center'>Hosting <FaChevronRight className="mx-2"/></li> 

    <li className='m-4 flex items-center'>Hosting 6 <FaChevronRight className="mx-2"/></li> 

    <li className='m-4'>Hosting 5</li>
  </ul>
</div>
        </div>
    );
